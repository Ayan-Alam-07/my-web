      ...
      <div className="row">
        <div className="col-12 px-lg-5 mt-lg-3">
          ...
          <p className={style.AboutPara}>
            VELoop is a trusted rewards platform empowering millions globally to
            earn money online effortlessly, securely, and daily through simple
            tasks and exciting offers.
          </p>
        </div>
      </div>
